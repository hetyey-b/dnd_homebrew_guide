export const weapons = {
	ambushWeapons: [
		{
			...
			master: ["two-handed", "melee d4", "affixed", "conceal", "entangle", "finesse", "lunge", "reach"],
		...
		},
		{
			...
			untrained: ["one-handed", "melee d4", "conceal", "finesse", "light", "nimble"],
			basic: ["one-handed", "melee d4", "conceal", "finesse", "light", "nimble", "puncture"],
			master: ["one-handed", "melee d4", "conceal", "finesse", "light", "nimble", "puncture"],
			...
			description: "A small knife attached to a horizontal handle that projects out from the fist when held. It can be easily deployed in a swift punching motion allowing a master true speed and precision unmatched.",
		},
		{
			name: "Gauntlet",
			gold: 1,
			...
			description: "Spiked or weighted knuckles worn as a glove or held in hand. A master's damage scales like Unarmed Strike, and can catch an enemy's weapon mid-swing. The hand with the gauntlet cannot be used to wield other equipment. ",
			untrained: [ "one-handed", "melee d4", "affixed", "deflect" ],
			basic: [ "one-handed", "melee d6", "affixed", "deflect", "disarm", "light", "nimble" ],
			master: [ "one-handed", "melee (table)", "affixed", "deflect", "disarm", "light", "nimble", "stagger" ],
		...
		{		
			...
			weight: 50,
			damageTypes: ["piercing"],
			description: "A mechanical means to instantly deploy a piercing dagger from under the wrist built into a bracer.  The master takes full advantage of a surprise attack, ending a life in an instant.", 
			untrained: [ "one-handed", "melee d4", "affixed", "awkward", "conceal", "finesse", "light", "nimble" ],
			basic: [ "one-handed", "melee d4", "affixed", "conceal", "finesse", "light", "nimble" ],
			master: [ "one-handed", "melee d4", "affixed", "conceal", "finesse", "light", "nimble" ],
		...
		},
		{
			...
			description: "A generic term for clothing used to deflect, such as a thick wool cloak, silk scarf, or wide brimmed hat. While you may wear an interceptor, it must be equipped to be used but gives you +1 Shield AC when equipped. The master can catch missile weapons in flight, even protecting an ally",
		...
		},
		{
			...
			weight: 1,
			damageTypes: ["piercing"],
			description: "A wide, leaf shaped blade mounted in line with the fist at the end of an H shaped handle. The katar is a unique punch weapon, and the master's speed and precision is unmatched",
			untrained: [ "one-handed", "melee d4", "awkward", "conceal", "finesse", "keen", "light", "nimble" ],
			basic: [ "one-handed", "melee d4", "conceal", "finesse", "keen", "light", "nimble" ],
			master: [ "one-handed", "melee d6", "conceal", "finesse", "keen", "light", "nimble" ],
		...
		},
		{
			...
			description: "Designed much like brass knuckles, but with a blade that sweeps back toward the forearm, over the side of the fist. The knuckle axe resembles an axe head with no handle, and either 4 finger holes or a curved handle to rest inside a closed fist. Masters with knuckle axes slash through soft targets much like a real axe, attacking two targets at once. ",
			untrained: [ "one-handed", "melee d4", "awkward", "finesse", "light", "keen" ],
		...
		},
		{
			...
			description: "Often called a Tonfa, Riot Baton, or Arm Club, this defensive weapon is designed to deflect attacks with the forearm. It is a stout club with a perpendicular handle attached a third of the way down the length, allowing it to be swung out for a swipe, or extend the reach of a thrust. A master uses the handle as a hook just effectively as an axe and maximizes the defensive properties of this weapon.",
	...
	axes: [
		{
			...
			weight: 4,
			damageTypes: ["slashing"],
			description: "An axe about 2ft-3ft in length, with a longer beard designed for a wider slashing wound. This weapon is large enough to use with two hands for more powerful strikes, yet nimble enough to be used in one hand. Masters with the battle axe are stout and reliable with their bit, and throw the axe with a large overhand pitch with both hands at the base of the handle.",
			...
			weight: 6,
			damageTypes: ["slashing"],
			description: "The classic barbarian axe, but which also includes more historical versions such as the bardiche, voulge, or Dane axe. The greataxe has incredible potential for damage, and the master greataxe wielder fells even the stoutest of foes with reliability not seen in many other weapon styles.",
			...
			weight: 2,
			damageTypes: ["slashing"],
			description: "An incredibly versatile weapon and tool, the hand axe can be thrown, or used in melee, and can be used to trip your foe, and the master binds and disarms with lightning efficiency. If you have a handaxe on your person, you may gain advantage on survival checks where the handaxe can be used to help, such as cutting firewood or putting up tents.",
	...
	bludgeons: [
		{
			...
			weight: 8,
			damageTypes: ["bludgeoning"],
			description: "A simple, heavy, two-handed club, though it can be refined like the Japanese Tetsubo. A master of the greatclub can render a weapon nearly useless by smashing it bent or broken.",
			...
			weight: 3,
			damageTypes: ["bludgeoning"],
			description: "A larger mass weapon, much like a bat or ball mace. A master can target the foe's head more easily, disorienting and disabling their foes with a wound-up swing for the fences.",
			...
			description: "A stout, arm length iron bar lined with spikes or flanges, more able to utilize prying leverage to deal with armored foes. Designed for low skilled military soldiers, a master uses the many angles to pry weapons from enemy's hands.",
			...
			description: "A metal head with bladed protrusions, attached to a simple shaft designed specifically to hammer and shred armor. Masters punch through any armor to damage  foes with ease.",
			...
			weight: 3,
			damageTypes: ["bludgeoning"],
			description: "Typically a crafter's tool, consisting of a shallow cylinder on a short handle. The lighter, faster bludgeon takes unique opportunities that other bludgeons would miss. A master uses the lightness of a mallet for a quick strike that sends the enemy reeling.",
			untrained: [ "one-handed", "melee d4", "light"],
			...
			weight: 3,
			damageTypes: ["bludgeoning"],
			description: "A quarterstaff is a heavier, thicker staff, meant for more weight and power in blocking than quick strikes in succession. Sometimes shod in iron, this staff provides increased protection for the master, able to use its shodding and length to provide a more stable means of defense.",
			untrained: [ "two-handed", "melee d6"],
			basic: [ "two-handed", "melee d8", "double ended d6", "trip" ],
			master: [ "two-handed", "melee d8", "double ended d8", "reach", "stagger", "trip" ],
	...
	bowsAndSlings: [
		...
		weight: 2,
		damageTypes: ["piercing"],
		description: "A larger bow than the shortbow, consisting of 5ft-6ft limbs, thick sinew cording bowstring, and a longer powerstroke. Perhaps a bit cumbersome in close combat and atop a mount, even so, a master archer steadies their aim in any situation, ignoring distractions which may impede accuracy.",
		untrained: [ "two-handed", "ranged d8 (100/500)", "awkward", "heavy" ],
		...
		weight: 2,
		damageTypes: ["piercing"],
		description: "A simple bow about 3ft in length, more suited to close combat, as its smaller size lends itself to agile movement and quick targeting on either side of the body. Masters with the shortbow can make snap shots as quickly as any swordsman reacts to an opening.",
	...
	combatBlades: [
		{
			...
			weight: 4,
			damageTypes: ["piercing", "slashing"],
			description: "The child of the Longsword and the Greatsword, a weapon in length between the two that combines both styles. A master deals greater damage against larger targets like the Greatsword, with deft precision of the tip much like a Longsword.",
			untrained: [ "two-handed", "melee d10", "awkward", "heavy" ],
			...
			weight: 3,
			damageTypes: ["piercing", "slashing"],
			description: "True broadswords have a wider blade to add power to the cut, and often perform more like an axe in the strike. Examples include the  messer, cleaver sword, or Chinese dadao. A master strikes through soft targets, driving their momentum to other targets.",
			...
			weight: 5,
			damageTypes: ["piercing", "slashing"],
			description: "Often as tall as its wielder, spanning in the 5ft-6ft range with a 2ft handle and a lengthy, wide blade. The long blade, lengthy handle, and added weight make the greatsword one of the most damaging melee weapons in use, and can easily dispatch larger targets with ease.  A master finds the greatest weapon to use against a large enemy is the greatsword.",
			...
			weight: 4,
			damageTypes: ["piercing", "slashing"],
			description: "A cusped falchion is slightly different from the broadsword from which it is descended. The straight blade with a curved tip and longer length was a later period design but iconic in appearance. This falchion exists as the two handed version of the broadsword. A master maximizes the falchion's cutting power, striking soft targets with critical accuracy.",
			untrained: [ "two-handed", "melee d8", "awkward" ],
			basic: [ "two-handed", "melee d10", "disarm", "penetrate" ],
			master: [ "one-handed", "melee d10", "disarm", "penetrate", "keen", "versatile d12" ],
			...
			weight: 2,
			damageTypes: ["piercing", "slashing"],
			description: "A Japanese single edged blade, slightly curved with a minimal guard and a long handle. The longer handle and curved edge provide greater leverage for more effective deflections. A master deflects even powerful blows with ease.",
			untrained: [ "two-handed", "melee d6", "awkward" ],
			basic: [ "one-handed", "melee d6", "finesse", "keen", "light", "versatile d8"],
			master: [ "one-handed", "melee d8", "deflect", "finesse", "keen", "light", "versatile d10" ],
			...
			weight: 3,
			damageTypes: ["piercing", "slashing"],
			description: "A multipurpose sword with a wide guard for dueling, heavy pommel for balance, and a fine, rapier point. Generally a hand and a half handle, this sword is favored by spellblades for its ease of use in one hand or two. Masters become devastatingly accurate, standing up to even master duelists.",
			untrained: [ "two-handed", "melee d8", "awkward" ],
			basic: [ "one-handed", "melee d8", "balanced", "disarm", "versatile d10" ],
			master: [ "one-handed", "melee d10", "balanced", "disarm", "versatile d12"],
	...
	crossbows: [
		{
			...
			weight: 1,
			damageTypes: ["piercing"],
			description: "A tube used to launch a needle dart with your breath. The dart is small and silent, and if you make an attack from stealth and miss, your location is not revealed. A master uses the art of the flying viper, shooting two darts at once and reloading with a single hand.",
			untrained: [ "one-handed", "ranged d1 (25/40)", "reload free", "hipshot", "keen" ],
			basic: [ "one-handed", "ranged d2 (25/100)", "reload free", "light", "hipshot", "keen"  ],
			master: [ "one-handed", "ranged d2 (25/100)", "light", "reload free", "light", "hipshot", "keen"  ],
			...
			weight: 2,
			damageTypes: ["piercing"],
			description: "A hand drawn bow on a pistol grip, these prods are weaker than other crossbows, but the drawstring can be pulled back without mechanical assistance. A master reloads one-handed, using the bolt case to draw and load in one motion.",
			untrained: [ "one-handed", "ranged d6+2 (20/60)", "light", "reload object interaction", "hipshot", "keen" ],
			basic: [ "one-handed", "ranged d6+2 (30/120)", "light", "reload free", "hipshot", "keen" ],
			master: [ "one-handed", "ranged d6+2 (30/120)", "light", "reload free", "hipshot", "keen" ],
			...
			weight: 8,
			damageTypes: ["piercing"],
			description: "A large crossbow with steel prods, loading over a thousand pounds of force. A master arbalist has become deadly accurate with their bolt, maximizing their sniper potential.",
			untrained: [ "two-handed", "ranged d10+4 (50/200)", "heavy", "keen", "penetrate", "puncture", "reload attack" ],
			basic: [ "two-handed", "ranged d10+4 (100/400)", "heavy", "keen", "penetrate", "puncture", "reload bonus", "trip"],
			master: [ "two-handed", "ranged d10+4 (100/400)", "heavy", "keen", "penetrate", "puncture", "reload reaction", "trip" ],
			...
			weight: 1,
			damageTypes: ["piercing"],
			description: "This wrist-mount is similar to a hidden blade, deploying in secret with one hand. The small mechanism can be pulled back by hooking it onto the needle case to reload one-handed. The master can shoot in melee at the slightest distraction.",
			untrained: [ "one-handed", "ranged d4+1 (10/30)", "reload reaction", "affixed", "awkward", "conceal", "hipshot", "light"],
			basic: [ "one-handed", "ranged d4+1 (20/40)", "reload object interaction", "affixed", "conceal", "hipshot", "light"],
			master: [ "one-handed", "ranged d4+1 (30/60)", "reload free", "affixed", "conceal", "hipshot", "light"],
			...
			weight: 5,
			damageTypes: ["piercing"],
			description: "A simple wooden crossbow drawn by pulling a lever. A master can move and shoot reflexively at moving targets.",
			untrained: [ "two-handed", "ranged d8+3 (40/200)", "reload bonus", "keen", "penetrate" ],
			basic: [ "two-handed", "ranged d8+3 (80/320)", "reload reaction", "keen", "penetrate" ],
			master: [ "two-handed", "ranged d8+3 (80/320)", "reload object interaction", "keen", "penetrate" ],
			...
			weight: 15,
			damageTypes: ["piercing"],
			description: "This small siege weapon is slow to reload with an enormous crannequin but the punch is worth the wait. Masters use flanking surfaces to pin a target with the launched javelin. A deployable stand can be purchased for 150g. As an action, you mount the ballista to the stand. While mounted, its reload is an object interaction, but you cannot move it until you use another action to unmount it.",
			untrained: [ "two-handed", "ranged d12+5 (150/400)", "awkward", "entangle", "heavy", "keen", "penetrate", "puncture", "reload action", "trip" ],
			basic: [ "two-handed", "ranged 2d6+5 (150/600)", "heavy", "entangle", "keen", "penetrate", "puncture", "reload attack", "trip"],
			master: [ "two-handed", "ranged 3d6+5 (150/600)", "heavy", "entangle", "keen", "penetrate", "puncture", "reload bonus", "trip" ],
			...
			weight: 2,
			damageTypes: ["slashing"],
			description: "This gnomish invention launches discus blades with internal mechanisms instead of prods. It holds ten blades, reloading for free by pulling the level located at the back of the weapon. When depleted, you must spend an action to reload ten more. Masters can attack several targets at once by expertly planning their ricochet path.",
			untrained: [ "two-handed", "ranged 2d4 (20/60)", "reload free", "awkward", "disarm", "hipshot" ],
			basic: [ "two-handed", "ranged 2d4 (30/120)", "reload free", "disarm", "hipshot" ],
			master: [ "two-handed", "ranged 2d4 (30/120)", "reload free", "disarm", "hipshot" ],
	...
	duelingBlades: [
		{
			...
			weight: 1,
			damageTypes: ["piercing", "slashing"],
			description: "Any forearm length blade can be called a dagger, and there are as many designs as there are cultures in existence. The master can make lightning fast attacks even while they focus their attention elsewhere.",
			untrained: [ "one-handed", "melee d4", "balanced", "finesse", "light" ],
			basic: [ "one-handed", "melee d4", "conceal", "balanced", "finesse", "light", "thrown (20/60)" ],
			master: [ "one-handed", "melee d4", "conceal", "balanced", "finesse", "light", "thrown (20/60)" ],
			...
			weight: 3,
			damageTypes: ["piercing"],
			description: "A variation of the longsword, this two handed thrusting weapon often had no cutting edge but a needle-like tip, called a tuck or a panzerstecher. The estoc was perfect for piercing mail and plate armor, making it prized among masters who leverage both arms to punching armor.",
			untrained: [ "two-handed", "melee d8", "awkward", "brace", "finesse", "penetrate", "puncture" ],
			basic: [ "two-handed", "melee d8", "brace", "finesse", "penetrate", "puncture", ],
			master: [ "two-handed", "melee d10", "brace", "finesse", "keen", "lunge", "penetrate", "puncture" ],
			...
			weight: 2,
			damageTypes: ["slashing"],
			description: "A thick, hooked blade with a cutting edge on the inside, performing more like a handaxe than a dagger. The wing shape flies somewhat like a boomerang, and the master uses its forward curve to hamstring enemies.",
			untrained: [ "one-handed", "melee d6", "keen", "light", "thrown (20/60)" ],
			basic: [ "one-handed", "melee d6", "finesse", "keen", "light", "thrown (40/80)", "trip" ],
			master: [ "one-handed", "melee d6", "disarm", "finesse", "keen", "light", "thrown (40/120)", "trip" ],
			...
			weight: 2,
			damageTypes: ["piercing", "slashing"],
			description: "A thin, tapered sword with a wide guard and extra weight in the handle for maximum control with the tip, prized as the pinnacle of finesse. Rapier masters are unmatched duelists with perfect reach and riposte.",
			untrained: [ "one-handed", "melee d6", "awkward" ],
			basic: [ "one-handed", "melee d8", "finesse", "puncture" ],
			master: [ "one-handed", "melee d8", "finesse", "light", "lunge", "puncture" ],
			...
			weight: 2,
			damageTypes: ["piercing", "slashing"],
			description: "Slightly curved, single-edged, one-handed weapons often with a basket hilt, allowing expert deflections off the curve. The master's defensive capabilities with the saber are unmatched among dueling blades.",
			untrained: [ "one-handed", "melee d6", "awkward" ],
			basic: [ "one-handed", "melee d8", "deflect", "finesse", "keen"],
			master: [ "one-handed", "melee 2d4", "deflect", "finesse", "keen",  "light" ],
			...
			weight: 1,
			damageTypes: ["piercing"],
			description: "A dagger sized weapon made famous in Okinawa, consisting of a sharpened metal rod with two forward swept prongs as a guard, making it easy to block and trap enemy weapons. The master parries and disarms in an instant with the prongs.",
			untrained: [ "one-handed", "melee d4", "awkward", "light", "nimble" ],
			basic: [ "one-handed", "melee d4", "conceal", "deflect", "finesse", "light", "nimble" ],
			master: [ "one-handed", "melee d4", "conceal", "deflect", "disarm", "finesse", "light", "nimble" ],
			...
			weight: 2,
			damageTypes: ["piercing", "slashing"],
			description: "Much like daggers, there are as many shortswords in the world as there are cultures who produced them. In general, they describe swords between 2ft-3ft in length, one-handed hilts, double or single edged and with a stabbing or curved point. Examples include weapons like a seax, cutlass, gladius, kopis, machetes, among many others. Their wide and varied designs mean that a master can find the perfect form for their style.",
			...
			weight: 2,
			damageTypes: ["piercing", "slashing"],
			description: "A crescent-shaped blade derived from a farming tool with the cutting edge on the inside. While not originally intended for dueling, a variety of dueling styles were developed by peoples needing to protect themselves with what they had. A master with the sickle has learned to grab with every attack and hamstring with the reaping curve.",
			untrained: [ "one-handed", "melee d4", "light", "keen", "puncture", "trip" ],
			basic: [ "one-handed", "melee d4", "entangle", "light", "keen", "puncture", "trip" ],
			master: [ "one-handed", "melee d6", "entangle", "light", "keen", "puncture", "trip" ],
			...
			weight: 1,
			damageTypes: ["piercing"],
			description: "A needle-like blade with a narrow profile and a fine tip, often given a dome shaped guard to protect the hands while thrusting. The smallsword can fit between any gaps in rings or between plates in armor, making it a serious threat to even the most armored in the hands of a duelist. The master has such control and poise that any distraction or detriment can be ignored with enough focus on the target.",
	...
	firearms: [
		{
			...
			weight: 5,
			damageTypes: ["piercing"],
			description: "A flared, muzzle loaded, short musket which uses a load of small pellets called shot. If an enemy is within 5ft of you, the weapon gains Penetrate. If two targets are within 5ft of one another and at least 30ft away from you, you can attack both targets as part of the same attack. A master overpacks the weapon to blast foes to the ground.",
			untrained: [ "two-handed", "ranged 2d8+5 (40/60)", "reload action", "awkward", "firearm", "hipshot", "trip" ],
			basic: [ "two-handed", "ranged 2d8+5 (40/60)", "reload attack", "firearm", "hipshot", "trip" ],
			master: [ "two-handed", "ranged 2d10+5 (40/60)", "reload attack", "firearm", "hipshot", "trip" ],
			...
			weight: 3,
			damageTypes: ["piercing", "slashing"],
			description: "A single edged sword with a barrel built into the spine. It has a pistol grip handle and a trigger hidden in the guard, but other variations of gunblade may exist, such as a gun axe or gun spear, which all use these properties. A master can seamlessly use the blade and bullets of a gunblade.",
			untrained: [ "one-handed", "ranged 2d6+5 (30/120)", "reload action", "melee d6", "awkward", "finesse", "firearm", "hipshot" ],
			basic: [ "one-handed", "ranged 2d6+5 (40/160)", "reload attack", "melee d8", "finesse", "firearm", "hipshot" ],
			master: [ "one-handed", "ranged 2d6+5 (50/200)", "reload attack", "melee 2d4", "finesse", "firearm", "hipshot" ],
			...
			weight: 3,
			damageTypes: ["piercing"],
			description: "A smooth bore, muzzle loaded, short range firearm that uses lead ball as ammunition, but the smaller barrel diameter and shorter length allows this weapon to be fired in melee. A master shoots from the hip, even while distracted or performing other tasks.",
			untrained: [ "one-handed", "ranged 2d6+5 (200/600)", "reload action", "awkward", "firearm", "hipshot", "puncture" ],
			basic: [ "one-handed", "ranged 2d6+5 (200/600)", "reload attack", "firearm", "hipshot", "puncture"],
			master: [ "one-handed", "ranged 2d8+5 (200/600)", "reload attack", "firearm", "hipshot", "puncture"],
			perk:" As a bonus action, you can make an attack with this weapon if you haven't used this weapon for an off-hand attack or held your action for an attack.  ",
			},
			{
			name:"Pepperbox",
			...
			weight: 1,
			damageTypes: ["piercing"],
			description: "A concealable firearm with two barrels on a swivel, firing twice before reloading. More barrels may be added by a master smith, but the weapon loses its conceal property and each added barrel increases the misfire range by 1. Turning the swivel requires an object interaction. As an action you reload two barrels. The master can unload a hail of gunfire at close range by firing all barrels within seconds.",
			untrained: [ "two-handed", "ranged d4+5 (30/120)", "reload action", "awkward", "firearm", "hipshot", "light"],
			basic: [ "one-handed", "ranged d4+5 (30/120)", "reload action", "conceal", "firearm", "hipshot", "light"],
			master: [ "one-handed", "ranged d4+5 (30/120)", "reload action", "conceal", "firearm", "hipshot", "light" ],
			...
			weight: 3,
			damageTypes: ["fire"],
			description: "A bracer with a hidden gunpowder compartment, but which can be filled with other substances similar to a firelance. The ranged attack is a 15ft line 5ft wide The master can deploy the fire at a moment's opportunity.",
			untrained: [ "one-handed", "ranged d4", "reload action", "awkward", "affixed", "conceal", "firearm", "hipshot", "light", "nimble"],
			basic: [ "one-handed", "ranged 2d4", "reload attack", "affixed", "conceal", "firearm", "hipshot", "light", "nimble"],
			master: [ "one-handed", "ranged 2d6", "reload bonus", "affixed", "conceal", "firearm", "hipshot", "light", "nimble"],
	...
	flailsAndWhips: [
		{
			...
			weight: 3,
			damageTypes: ["piercing", "bludgeoning"],
			description: "The familiar 2lb spiked ball at the end of a length of  chain, attached to a short iron or wooden haft usually  similar in length to a handaxe. The light flail sees  lightning fast attacks turned into a great boon for the  master, carrying the weapons speed and momentum  into another attack if they miss.",
			...
			weight: 5,
			damageTypes: ["piercing", "bludgeoning"],
			description: "A large spiked metal bar attached to a long handle, allowing one or two handed usage. The massive head and lengthy chain put it in the same sphere of war as the warhammer and battle axe. A master's binding and tripping attacks still harm their target if the enemy resists the maneuver.",
			untrained: [ "two-handed", "melee d8", "awkward", "heavy", "penetrate" ],
			basic: [ "one-handed", "melee d8", "entangle", "heavy", "penetrate", "trip", "versatile d10" ],
			...
			weight: 10,
			damageTypes: ["piercing", "bludgeoning"],
			description: "A pole weapon with a spiked bar of the heavy flail at the end of a chain. The master learns to bind and wrap opponents, disrupting their footwork to allow their own free movement.",
			...
			weight: 3,
			damageTypes: ["bludgeoning"],
			description: "A small weight attached to a rope or chain, used like rope dart to make circular and explosive lunging attacks. A master can twirl the weapon around them with varying angles to strike any foe who might get near.",
			untrained: [ "two-handed", "melee d4", "awkward", "conceal", "finesse", "lunge", "reach" ],
			basic: [ "two-handed", "melee d4", "conceal", "entangle", "finesse", "lunge", "reach", "trip" ],
			master: [ "two-handed", "melee d4", "conceal", "disarm", "entangle", "finesse", "lunge", "reach", "trip" ],
			...
			weight: 1,
			damageTypes: ["bludgeoning"],
			description: "Made famous in Okinawa, the nunchaku is two rods bound by a rope or chain. By whipping around the body, it can make dizzyingly fast attacks, and despite being a one-handed weapon, a master can wield it like a Double Ended weapon. ",
			untrained: [ "one-handed", "melee d4", "conceal", "finesse" ],
			basic: [ "one-handed", "melee d4", "conceal", "entangle", "finesse", "light", "trip" ],
			master: [ "one-handed", "melee d4", "conceal", "disarm", "double ended d4", "entangle", "finesse", "light", "trip" ],
			...
			weight: 3,
			damageTypes: ["bludgeoning"],
			description: "A quarterstaff cut into three sections, each connected with a small length of chain or rope. A master uses this weapon's double hinges to strike in unpredictable ways, tripping or entangling with either end of the weapon.",
			untrained: [ "two-handed", "awkward", "finesse", "melee d6"],
			basic: [ "two-handed", "melee d6", "double ended d4", "entangle", "finesse", "trip" ],
			master: [ "two-handed", "melee d6", "balanced", "disarm", "double ended d6", "entangle", "finesse", "trip" ],
			...
			weight: 1,
			damageTypes: ["slashing"],
			description: "The whip is treated as a melee weapon with 15ft reach. You can use a whip to grasp unattended small objects, or any reasonable handhold within range and if possible, you can pull the object to you. A whip master treats their whips as extensions of their hands. ",
			untrained: [ "one-handed", "melee d2", "awkward", "finesse" ],
			basic: [ "one-handed", "melee d4", "disarm", "finesse", "reach (15ft)", "trip" ],
			master: [ "one-handed", "melee d6", "disarm", "entangle", "finesse", "keen", "light", "reach (15ft)", "trip" ],
			...
			basic: [ "one-handed", "melee d6", "barbed", "entangle", "finesse", "reach", "trip" ],
			master: [ "one-handed", "melee d8", "barbed", "entangle", "finesse", "reach", "trip" ],
	...
	hammersAndPicks: [
		{
			...
			weight: 2,
			damageTypes: ["bludgeoning"],
			description: "A short-handled hammer about the size of a handaxe and just as balanced for throwing. While a mace may shred armor, a hammer delivers precise blows that weaken the enemy, and a master can disorient the opponent for follow up attacks.",
			untrained: [ "one-handed", "melee d6", "thrown (10/40)", "awkward", "light", "penetrate" ],
			basic: [ "one-handed", "melee d6", "thrown (20/60)", "light", "penetrate" ],
			master: [ "one-handed", "melee d6", "thrown (20/60)", "light", "penetrate"  ],
			...
			weight: 3,
			damageTypes: ["bludgeoning"],
			description: "Historically a lightweight, long-handled weapon around 3ft-4ft in length, designed to damage armored enemies. The small, pronged hammer head is often backed with a military pick or different style of face. A master of the warhammer carries momentum into each attack to send foes reeling.",
			untrained: [ "one-handed", "melee d8", "awkward", "penetrate", "stagger", "sunder" ],
			basic: [ "one-handed", "melee d8", "penetrate", "stagger", "sunder", "versatile d10"],
			master: [ "one-handed", "melee d10", "penetrate", "stagger", "sunder", "versatile d12"],
			...
			weight: 8,
			damageTypes: ["piercing", "bludgeoning"],
			description: "A pole mounted, pronged hammer head for crushing blows on one side and a vicious hooking spike head for piercing and peeling armor on the other. The long haft allows the wielder to put devastating force behind the blows of this weapon. Lucerne masters swing at angles which force their enemies to choose between sacrificing equipment or flesh.",
			untrained: ["two-handed", "melee 2d6", "awkward", "brace", "heavy", "penetrate", "puncture", "reach", "sunder"],
			basic: ["two-handed", "melee 2d6", "brace", "heavy", "penetrate", "puncture", "reach", "sunder", "trip"],
			master: ["two-handed", "melee 2d6", "brace", "heavy", "penetrate", "puncture", "reach", "sunder", "trip"],
			...
			weight: 1,
			damageTypes: ["piercing"],
			description: "A long, thin pick, mounted to a short haft, capable of precise, targeted piercing attacks that punch through armor with ease. Though not as stout as a war pick, the light pick allows more agile maneuvers, as well as balanced throwing. A master looks for the perfect opening, placing the pick into soft targets or between plates where armor is lacking.",
			untrained: ["one-handed", "melee d4", "thrown (10/40)", "finesse", "light", "penetrate"],
			...
			weight: 1,
			damageTypes: ["piercing"],
			description: "Similar in size to the light pick, with a longer, hooked spike to aid in climbing. In combat, the hook is used to grapple or disarm enemies while still able to puncture and pierce armor. A wall pick gives you advantage on climb checks and you can climb onto creatures any size category bigger than you. The master can grapple a foe as easily as they latch onto a wall.",
			untrained: ["one-handed", "melee d4", "thrown (10/40)", "awkward", "barbed", "penetrate"],
			basic: ["one-handed", "melee d4", "thrown (20/60)", "barbed", "entangle", "light", "penetrate", "trip"],
			master: ["one-handed", "melee d6", "finesse", "thrown (20/60)", "barbed", "disarm", "entangle", "light", "penetrate", "trip"],
			...
			weight: 2,
			damageTypes: ["piercing"],
			description: "A weaponized miner's pick, famously invented by militant mountain dwarves, refined worldwide for use against armored infantries. The pick comes in many forms but is usually a battle axe sized weapon with a reinforced spike on one end, and a narrow hammer opposite the spike. The master can strike vital areas, puncturing deeply to bleed the target out over time.",
			untrained: ["one-handed", "melee d8", "awkward", "penetrate", "puncture", "sunder"],
			basic: ["one-handed", "melee d8", "penetrate", "puncture", "sunder", "trip"],
			master: ["one-handed", "melee d10", "penetrate", "puncture", "sunder", "trip"],
			...
			weight: 1,
			damageTypes: ["piercing"],
			description: "A thin, round spike with a thin point and round cross section make it perfect for fitting between or outright puncturing through metal plates or rings. A master employs a host of grappling techniques as follow ups to their initial attacks.",
			untrained: [ "one-handed", "melee d4", "finesse", "light", "penetrate", "puncture" ],
			basic: [ "one-handed", "melee d4", "conceal", "finesse", "light", "penetrate", "puncture" ],
			master: [ "one-handed", "melee d4", "conceal", "entangle", "finesse", "light", "penetrate", "puncture" ],
	...
	polearms: [
		{
			...
			master: ["two-handed", "melee 2d6", "brace", "finesse", "reach", "lunge", "heavy"],
			...
			weight: 5,
			damageTypes: ["slashing"],
			description: "A sharpened and sturdy pruning hook, developed as a peasant weapon from modifying a farm tool. The curved hook of the blade allows the guisarme to be used as a tripping weapon or to pull foes from the saddle. A Guisarme is a favorite of common militias who will face cavalry in battle, as the master can pull a knight from the saddle with relative ease.",
			untrained: ["two-handed", "melee d10", "brace", "keen", "reach", "trip", "heavy"],
			basic: ["two-handed", "melee d12", "brace", "keen", "reach", "trip", "heavy"],
			master: ["two-handed", "melee 2d6", "brace", "keen", "reach", "trip", "heavy"],
			...
			weight: 8,
			damageTypes: ["piercing", "slashing"],
			description: "Whether mounted horizontally like a traditional farming implement, or mounted vertically like a glaive, a war scythe has its roots in a peasant militia looking to arm itself in times of war. A scythe in the right hands can be useful in combat, though it takes a practiced master to be truly effective. The master uses the scythe's reaping motion to deal horrible slashing wounds to the foes they trip in combat.",
			untrained: ["two-handed", "melee 2d6", "heavy", "keen", "puncture", "reach", "sunder", "trip" ],
			basic: ["two-handed", "melee 2d6", "heavy", "keen", "entangle", "puncture", "reach", "sunder", "trip"],
			master: ["two-handed", "melee 2d6", "heavy", "keen", "entangle", "puncture", "reach", "sunder", "trip"],
	...
	spears: [
		{
			...
			weight: 5,
			damageTypes: ["piercing", "bludgeoning"],
			description: "A short spear with a heavy ball socket to hold the spear point, making use of sweeping bludgeons and weighted piercing attacks. The master makes full use of the added weight for powerful blows that set their enemy off balance.",
			...
			weight: 1,
			damageTypes: ["piercing"],
			description: "A light throwing spear balanced for flight but sturdy enough as a simple spear. A master can make an Olympian throw, puncturing shields so deeply, the enemy must pry the remnants out before it can be of any use in combat.",
			untrained: ["one-handed", "melee d6", "thrown (20/60)", "light", "penetrate"],
			basic: ["one-handed", "melee d6", "thrown (30/120)", "light", "penetrate", "sunder"],
			master: ["one-handed", "melee d8", "thrown (30/240)", "light", "penetrate", "sunder"],
			...
			weight: 3,
			damageTypes: ["piercing"],
			description: "A 6ft spear with a thick shaft, shod in banding and with a hefty counterweight to provide maximum tip control one handed, or a brutal bludgeon while wielded in two hands, which makes it very balanced for throwing. A war spear is the soldier's ideal weapon on the front line, and a master is a true war fighter, using spear techniques as ancient and true as the armies that employed them.",
			untrained: ["two-handed", "melee d8", "awkward"],
			basic: ["one-handed", "melee d8", "thrown (20/60)", "balanced", "finesse", "penetrate", "puncture", "versatile d10"],
			master: ["one-handed", "melee d10", "thrown (30/120)", "balanced", "double ended d4", "finesse", "penetrate", "puncture", "versatile d12"],
			...
			weight: 3,
			damageTypes: ["piercing", "slashing"],
			description: "A war spear with a crescent shaped hook on one side of the tip, to be used to hook or slash. The added weight reduces its versatility, but the hook's utility more than makes up the difference. In the hands of a master, the beak can be used to redirect attacks into an enemy's allies.",
			...
			weight: 3,
			damageTypes: ["piercing"],
			description: "Traditionally a fishing tool, the war trident is repurposed with little modification. Three prongs more reliably damage than an ordinary spear, and the master can trap, bind and disarm enemies with ease.",
			untrained: ["one-handed", "melee d8", "awkward"],
			basic: ["one-handed", "melee d8", "disarm", "thrown (20/60)", "versatile 2d4"],
			master: ["one-handed", "melee d12", "deflect", "disarm", "thrown (30/120)", "versatile 3d4"],
	...
	throwingWeapons: [
		{
			...
			weight: 1,
			damageTypes: ["slashing", "bludgeoning"],
			description: "A hooked wing, sharpened on the inner curve and used like a cudgel. The master can curve its flight path to hit more than one target with a powerful throw.",
			untrained: ["one-handed", "melee d6", "thrown (30/120)", "awkward", "light"],
			basic: ["one-handed", "melee d6", "thrown (40/120)", "disarm", "finesse", "light"],
			master: ["one-handed", "melee d6", "thrown (80/240)", "disarm", "finesse", "light", "stagger"],
			...
			weight: 0.1,
			damageTypes: ["slashing"],
			description: "A sharpened discus or ring, sturdy enough to be used in melee. Dangerous from all angles, the master uses any opening as an opportunity for a quick throw or slash.",
			untrained: ["one-handed", "melee d4", "thrown (20/60)", "awkward", "keen", "light"],
			basic: ["one-handed", "melee d6", "thrown (40/120)", "finesse", "keen", "light"],
			master: ["one-handed", "melee d8", "thrown (80/500)", "finesse", "keen", "light"],
			...
			weight: 0.05,
			damageTypes: ["piercing"],
			description: "A short rod fletched like an arrow with a weighted tip. A master pins targets with precision aimed at clothing.",
			untrained: ["one-handed", "thrown d4 (20/60)", "finesse", "light", "penetrate", "puncture"],
			basic: ["one-handed", "thrown d4 (30/60)", "finesse",  "light", "penetrate", "puncture"],
			master: ["one-handed", "thrown d6 (60/120)", "finesse", "light", "penetrate", "puncture"],
			...
			weight: 0.1,
			damageTypes: ["piercing"],
			description: "A small, dagger-like tool of Japanese origin derived from a masonry trowel. Its ring pommel and wide design allow for unique utility with rope, and in the hands of a master, the heavier design allows for deflections mid-flight .",
			untrained: ["one-handed", "melee d4", "thrown (20/60)", "conceal", "finesse", "light"],
			basic: ["one-handed", "melee d4", "thrown (20/60)", "conceal", "deflect", "finesse", "light"],
			master: ["one-handed", "melee d6", "thrown (30/90)", "conceal", "deflect", "finesse", "light"],
			...
			master: ["one-handed", "thrown (15/30)", "deflect d6", "entangle", "trip"],
			...
			weight: 6,
			damageTypes: ["bludgeoning"],
			description: "Though not strictly their invention, the technique to throw an iron ball in combat was pioneered by the Orcs. Not many can stand up to the heavy iron in flight. A master is deadly accurate with the shot and is able to target an enemy's head to stun if they have an advantage.  A creature with Strength less than 13 cannot wield a shot at all.",
			untrained: ["one-handed", "thrown d8 (10ft)", "awkward", "penetrate", "stagger"],
			basic: ["one-handed", "thrown d10 (20/60)", "penetrate", "stagger", "trip"],
			master: ["one-handed", "thrown d12 (30/90)", "disarm", "penetrate", "stagger", "trip", "versatile 2d8"],
			...
			weight: 0.05,
			damageTypes: ["piercing"],
			description: "Star shaped metal disks made to be palmed together and thrown as a pepper of smaller strikes to disable an enemy before a followup attack. The flat, small design of these weapons allows many to be palmed at once and thrown all together. A master has the capability to dance in a quick circle, throwing stars at all foes around them.",
			untrained: ["one-handed", "thrown d4 (10/30)", "conceal", "finesse", "light", "nimble"],
			basic: ["one-handed", "thrown d4 (20/60)", "conceal", "finesse", "light", "nimble"],
			master: ["one-handed", "thrown d4 (40/120)", "conceal", "finesse", "light", "nimble"],
